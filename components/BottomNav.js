            ...
            >
              <span className="flex w-[35px] h-[35px] items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="27" height="27">
                  <path fill="url(#a)" fillRule="evenodd" d="M13.333 26.667C5.973 26.667 0 20.707 0 13.333 0 5.973 5.973 0 13.333 0c7.374 0 13.334 5.973 13.334 13.333 0 7.374-5.96 13.334-13.334 13.334m4.254-8.387a.99.99 0 0 0 1.373-.347c.28-.466.133-1.08-.347-1.373l-4.746-2.827v-6.16c0-.56-.454-1-1-1-.547 0-1 .44-1 1v6.734c0 .346.186.666.493.853z" clipRule="evenodd"/>
                  <defs>
                    <linearGradient id="a" x1="6.591" x2="20.454" y1="22.046" y2="6.742" gradientUnits="userSpaceOnUse">
